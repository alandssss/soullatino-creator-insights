...
DROP FUNCTION IF EXISTS public.calcular_bonificaciones_mes(p_mes_referencia date);

-- Crear la función corregida para calcular bonificaciones basadas en LIVE del mes
