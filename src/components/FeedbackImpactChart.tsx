    ...
    <Card className="bg-card/80 backdrop-blur-sm border-border/30">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
          <div className="text-center p-3 sm:p-4 rounded-lg bg-accent/10 border border-accent/20">
            <Users className="h-4 w-4 sm:h-5 sm:w-5 mx-auto mb-2 text-accent" />
            <div className="text-xl sm:text-2xl font-bold text-foreground">{stats.totalCreators}</div>
            <div className="text-xs text-muted-foreground">Creadores apoyados</div>
          </div>
          <div className="text-center p-3 sm:p-4 rounded-lg bg-secondary/30 border border-secondary/40">
            <TrendingUp className="h-4 w-4 sm:h-5 sm:w-5 mx-auto mb-2 text-secondary-foreground" />
            <div className="text-xl sm:text-2xl font-bold text-foreground">+{stats.avgDiamanteIncrease.toLocaleString()}</div>
          ...
          <div className="text-center p-3 sm:p-4 rounded-lg bg-green-500/10 border border-green-500/20">
            <BarChart3 className="h-4 w-4 sm:h-5 sm:w-5 mx-auto mb-2 text-green-500" />
            <div className="text-xl sm:text-2xl font-bold text-foreground">+{stats.avgEngagementIncrease}%</div>
