...
export default function WhatsappButton({ phone, country="MX", message, className }:{
  phone?: string|null; country?: "MX"|"CO"|"VE"|string; message: string; className?: string;
}) {
  const e164 = phone ? normalizePhoneE164(phone, String(country).toUpperCase()) : null;
